...
Select your OnsetData asset in the Project window
Click "Analyze Track" button in the Inspector (this prepares the analysis)
Open the AudioAnalysisScene (the dedicated scene for analysis)
In the AudioAnalysisScene, find the AudioAnalyzer GameObject
Assign your OnsetData asset to the AudioAnalyzer component's OnsetData field
Verify analysis settings in the assigned OnsetData asset
Press Play in Unity Editor
Wait for the entire track to finish playing (watch Console for progress)
When complete, Console will show: "Analysis complete! Found X onsets"
Console will prompt: "MANUALLY EXIT PLAY MODE NOW!"
Exit Play mode
Your OnsetData asset now contains all detected onset times
...
Add Animation Event OnbeatHit at desired frames
